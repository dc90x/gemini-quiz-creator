...
if __name__ == "__main__":
    ...
    if question_bank:
        ...
        with st.container():
            ...
            quiz_manager = QuizManager(question_bank) # Use the QuizManager
            
            with st.form("Multiple Choice Question"):  # Format the question and display
                ...
                for choice in index_question['choices']: # For loop unpack the data structure
                    ...
                    key = choice.get("key") # Set the key from the index question
                    value = choice.get("value") # Set the value from the index question
